...
mod_norm_degreeW1_obs$save_object('causal_mod_norm_degreeW1_2.rds')
...
mod_norm_degreeW5_obs$save_object('causal_mod_norm_degreeW5_2.rds')
...
mod_norm_degreeW10_obs$save_object('causal_mod_norm_degreeW10_2.rds')
...
mod_norm_degreeW15_obs$save_object('causal_mod_norm_degreeW15_2.rds')
...
mod_norm_degreeW20_obs$save_object('causal_mod_norm_degreeW20_2.rds')
...
mod_norm_degreeW25_obs$save_object('causal_mod_norm_degreeW25_2.rds')
...
plot_effects_norm_degreeWET2 <- 
  ...
  filter(rainfall_level == 'High SL rainfall' |
           rainfall_level == 'Low SL rainfall') |> 
  ggplot() +
  geom_vline(xintercept = 0, linetype = 3, col = 'red') +
  geom_errorbar(aes(y = key, xmin = li, 
                    xmax = ls, color = window), 
...
plot_grid(plot_beta_clusteringDRY2, 
          plot_effects_norm_degreeWET2, 
          ncol = 1)

plot_beta_clusteringDRY2 / plot_effects_norm_degreeWET2 +
  plot_layout(heights = c(0.45, 1))

ggsave('wet_season_norm_degree_clus.jpg', units = 'cm', dpi = 1500,
       height = 25, width = 12)
...
plot_effects_norm_degreeWET2 | plot_effects_norm_degreeDRY +
  plot_layout(ncol = 1)
...
ggsave('SHER_rain_swarm_norm_degree.jpg', units = 'cm', dpi = 1000, 
       height = 7, width = 14)
...
plot(density(counterfact_ND_SHER(min, W = 25)))
lines(density(counterfact_ND_SHER(mean, W = 25)), col = 'blue')
lines(density(counterfact_ND_SHER(max, W = 25)), col = 'red')
...
ggsave('PRL_AB_norm_degree.jpg', units = 'cm', dpi = 1000, 
       height = 7, width = 7)
...
plot(density(counterfact_ND_PRL(min, W = 25)))
lines(density(counterfact_ND_PRL(mean, W = 25)), col = 'blue')
lines(density(counterfact_ND_PRL(max, W = 25)), col = 'red')
...
ggsave('causal_eff_AB_PRL.jpg', units = 'cm', dpi = 1000, 
       height = 5, width = 14)


# ========= swarm area and arthropod biomass ===========
...
unique(post_swarm_AB$effect)

# column > row
# Arthropod biomass
# Dry
tables_swarm_AB_EFFECT(eff = 'Arthropod biomass', 
                       season = 'Dry', 
                       p = T, 
                       .fun = mean)
tables_swarm_AB_EFFECT(eff = 'Arthropod biomass', 
...
# Swarm area
# Dry
tables_swarm_AB_EFFECT(eff = 'Swarm area', 
                       season = 'Dry', 
                       p = T, 
                       .fun = mean)
tables_swarm_AB_EFFECT(eff = 'Swarm area', 
